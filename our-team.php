  ...
  <section class="section-75 section-md-100 section-lg-150">
    <div class="shell range-offset-1">
	  ...
	  <div class="cell-lg-12 bio-area">
        ...
        <div class="cell-lg-12 bio-area">
          <div class="range range-sm-middle">
            <div class="cell-md-3"><img src="images/bio-pics/tyler-adam-martinez.png" alt="" width="360" height="404" class="img-responsive" />
            </div>
            <div class="cell-md-6">
              <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">
        ...
        <div class="cell-lg-12 bio-area">
          <div class="range range-sm-middle">
            <div class="cell-md-3"><img src="images/bio-pics/nicole-kohm.jpeg" alt="" width="360" height="404" class="img-responsive" />
            </div>
            <div class="cell-md-6">
              <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">
