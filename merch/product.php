...
<style>
	...
	*/
	.variant-btn {
		...
		/* Uniform spacing so every payment button is evenly stacked (no double margins). */
		.pay-buttons #express-checkout-element, .pay-buttons #applepay-redirect, .pay-buttons #paypal-button-container, .pay-buttons #stripe-pay-button { margin: 0 0 10px !important; }
		.pay-buttons #express-checkout-element:empty { margin: 0 !important; }
		.pay-buttons .offset-top-10 { margin-top: 0 !important; }
