...
<main class="page-content">
    ...
    <div class = "inset-md-right-30 inset-lg-right-0">
        <h1 style = "margin: 20px">${team name} stream page</h1>
        <h3 style = "margin: 20px">Team number: ${team-num}</h3>
...
<script>
    ...
    //    //TODO send json with team num (+ 100) + secret key
    //    //query and see if they are on this team
    //
    //    //pseudocode
    ...
    //
    //
    //    //FORMAT example: "TEAM_105_SECRET_KEY TEAM_(team number)_(secret key"
    //    <?php
    //        //query for team num and secret key
    //        global $userinfo;
    //        $euid = $userinfo['unteuid'];
    //
    //        //query for team and secret
    //        $team_no = 1;
    //        $secret_key = 1;
    //
    //        $validate = new stdClass();
