...
$eras = array(
    array(
        ...
        'body' => "The club&rsquo;s modern era begins. Its Discord, still the organizational backbone today, was created in <strong>October 2019</strong>, growing out of a student rocketry effort that joined forces with UNT&rsquo;s existing robotics group. Members designed the first logo and set their sights on big goals: NASA Student Launch and intercollegiate rocketry. That same year, the competition team took <strong>first place at IEEE Region 5</strong> with an autonomous balloon-popping drone.",
    ...
    array(
        ...
        'body' => "A roles-and-divisions system launched so members could self-select the project teams they wanted, from rocketry to robotics and more. When COVID-19 closed campus, the club kept building online through Zoom and Discord, running CAD and OpenRocket workshops and fielding a VEX&nbsp;U competition team.",
    ...
    array(
        ...
        'body' => "As campus reopened, membership exploded, with <strong>153 new members in a single month</strong> (September 2021), the largest recruiting spike in the club&rsquo;s history. Officers tabled at Discovery Park, ran the first full slate of officer elections, and moved general meetings back in person.",
        'img' => 'events/group-work-session.jpg',
        'gallery' => array(),
    ),
    array(
        'year' => '2022',
        'title' => 'Botathon becomes the flagship, and the Rover begins',
    ...
    array(
        ...
        'body' => "The 4th annual Botathon ran a Mario-Kart-themed robot race, and club projects were featured at Senior Design Day. Members ran a deep slate of workshops: KiCad PCB design with a professional guest, GPS/radio programming, NLP in Python, and drones and deep learning.",
    ...
    array(
        ...
        'body' => "The club voted to enter <strong>RoboMasters</strong>, the international collegiate robotics competition. Weekend build sessions brought the rideable, self-driving <strong>Sofabot</strong> to life, and a brand-new flagship robot (<strong>Scrapp-E</strong>, the club mascot) began taking shape. Guest speakers included NASA figures and researchers from UNT&rsquo;s robotics labs.",
    ...
    array(
        ...
        'body' => "The club tabled at Spring Fling, ran a semester of structured intro projects (an Arduino piano, a 3D-printed robotic arm and quadruped), and began prep for the next Botathon. Seven seasons of Botathon in, and the workshop lights are still on.",
