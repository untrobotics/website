        ...
        <section class="section-25 section-md-50 section-lg-75">
            ...
            <div class="shell text-sm-left">
                <div class="range text-center">
                    <div class="col-lg-12">
                        <iframe src="https://calendar.google.com/calendar/embed?src=untroboticsclub%40gmail.com&ctz=America%2FChicago" class="calendarFix" style="border: 0" height="600" frameborder="0" scrolling="no"></iframe>
                    </div>
                </div>
            </div>
        </section>
