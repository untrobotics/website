            ...
            <div class="shell range-offset-1">
                ...
                <div class="cell-lg-12 bio-area">
                    <div class="range range-sm-middle">
                        <div class="cell-md-3"><img src="/images/web-team-pics/peyton-thibodeaux.jpg" alt="" width="360" height="404" class="img-responsive" />
                        </div>
                        <div class="cell-md-6">
                            <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">
                                <h6 class="h6-with-small"><p> Peyton Thibodeaux</p><span class="small text-silver-chalice">Webmaster | Team Member</span></h6>
                ...
                <div class="cell-lg-12 bio-area">
                    <div class="range range-sm-middle">
                        <div class="cell-md-3"><img src="/images/web-team-pics/sebastian-king.jpg" alt="" width="360" height="404" class="img-responsive" />
                        </div>
                        <div class="cell-md-6">
                            <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">
                                <h6 class="h6-with-small"><p> Sebastian King</p><span class="small text-silver-chalice">Alumni | Team Member</span></h6>
                ...
                <div class="cell-lg-12 bio-area">
                    <div class="range range-sm-middle">
                        <div class="cell-md-3"><img src="/images/web-team-pics/nick-tindle.jpg" alt="" width="360" height="404" class="img-responsive" />
                        </div>
                        <div class="cell-md-6">
                            <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">
                                <h6 class="h6-with-small"><p> Nicholas Tindle</p><span class="small text-silver-chalice">President | Team Member</span></h6>
                ...
                <div class="cell-lg-12 bio-area">
                    <div class="range range-sm-middle">
                        <div class="cell-md-3"><img src="/images/web-team-pics/mason-besmer.png" alt="" width="360" height="404" class="img-responsive" />
                        </div>
                        <div class="cell-md-6">
                            <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">
                                <h6 class="h6-with-small"><p> Mason Besmer</p><span class="small text-silver-chalice">Team Member</span></h6>
...
<!--                            <div class="cell-lg-12 bio-area">-->
<!--                                <div class="range range-sm-middle">-->
<!--                                    <div class="cell-md-3"><img src="/images/web-team-pics/fileName.jpg" alt="" width="360" height="404" class="img-responsive" />-->
<!--                                    </div>-->
<!--                                    <div class="cell-md-6">-->
<!--                                        <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">-->
<!--                                            <h6 class="h6-with-small"><p> FirstName LastName</p><span class="small text-silver-chalice">Team Member</span></h6>-->
