            ...
            <div class="shell range-offset-1">
                    ...
                    <div class="range range-sm-middle">
                        ...
                        <div class="cell-md-6">
                            <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">
                                <h6 class="h6-with-small"><a href="#"> Alex Ferguson</a><span class="small text-silver-chalice">President</span></h6>
                                <p>Alex is a mechanical engineering junior specializing in design and management. As President of the organisation, he oversees its direction and ensures it serves it purpose. He has been competing in robotics competitions ever since middle school and has a plethora of skills to teach to and mentor new roboticists and enthusiasts. These experiences have led to his form belief that projects are the best way for engineers to learn and test their skills, not only in isolation, but in conjunction with other disciplines. With that in mind he hopes to give the students of UNT the opportunity to learn engineering the proper way.</p>
                ...
                <div class="cell-lg-12 bio-area">
                    <div class="range range-sm-middle">
                        ...
                        <div class="cell-md-6">
                            <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">
                                <h6 class="h6-with-small"><a href="#"> Sebastian King</a><span class="small text-silver-chalice">Vice President</span></h6>
                ...
                <div class="cell-lg-12 bio-area">
                    <div class="range range-sm-middle">
                        ...
                        <div class="cell-md-6">
                            <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">
                                <h6 class="h6-with-small"><a href="#"> Lauren Caves</a><span class="small text-silver-chalice">Secretary</span></h6>
                ...
                <div class="cell-lg-12 bio-area">
                    <div class="range range-sm-middle">
                        ...
                        <div class="cell-md-6">
                            <div class="inset-xl-right-70 inset-xl-left-70 inset-left-15 inset-right-15">
                                <h6 class="h6-with-small"><a href="#"> Jesus Patiño</a><span class="small text-silver-chalice">Public Relations</span></h6>
                                <p>Jesus is the Public Relations officer. He loves to help people, enjoys our fun and social activities, while stretching his legs with hobby of graphics design. He’s also runs our socials, so send a message to @untrobotics to say Hi at any time!</p>
                                <ul class="list-inline-lg">
                                    <li>
