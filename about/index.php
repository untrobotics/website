...
head('About Us', true);
?><!--require(BASE . '/api/discord/bots/admin.php'); require(BASE . '/api/google/count_majors.php');-->
	<main class="page-content">
        <!-- Classic Breadcrumbs-->
        <section class="breadcrumb-classic">
          <div class="rd-parallax">
            <div data-speed="0.25" data-type="media" data-url="/images/headers/default.jpg" class="rd-parallax-layer"></div>
        ...
        <section class="section-75 section-md-100 section-lg-150">
		  ...
		  <h3>Overview</h3>
                  ...
                  <p>We have invited several companies across disciplines such as L3, RoboKind, and StandardUser CyberSecurity. These companies were chosen because they fit the major demographics of our organization: Mechanical, Biomedical, and computer science/engineering.</p>
                  ...
                  <div class="well-custom">
                      <!--<h5><strong> echo AdminBot::get_member_count(); ?></strong> members from <strong> echo count(get_majors()); ?></strong> majors.</h5> this had php tags but i removed them-->
                      <h5><strong>433</strong> members from <strong>10</strong> majors.</h5>
                  </div>
