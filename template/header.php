            ...
            <nav data-stick-up-clone="true" data-layout="rd-navbar-fixed" data-md-layout="rd-navbar-static"
                ...
                <div class="rd-navbar-inner">
                    <ul class="list-inline list-inline-lg offset-top-0">
                        ...
                        <li><a href="<?php echo SOCIAL_MEDIA_FACEBOOK_URL; ?>"
                               class="ioon icon-md2 icon-silver-chalice fa-facebook"></a></li>
                        <li><a href="<?php echo SOCIAL_MEDIA_TWITTER_URL; ?>"
                               class="ioon icon-md2 icon-silver-chalice fa-twitter"></a></li>
                        <li><a href="<?php echo SOCIAL_MEDIA_INSTAGRAM_URL; ?>"
                               class="ioon icon-md2 icon-silver-chalice fa-instagram"></a></li>
                    </ul>
                </div>
                <div class="rd-navbar-inner">
                    <!-- RD Navbar Panel-->
                    ...
                    <div class="rd-navbar-collapse animated">
                                ...
                                <li>
                                    <div class="unit unit-horizontal unit-spacing-xs">
                                        ...
                                        <div class="unit-body">
                                            ...
                                            <h6>
                                                <a href="callto:<?php echo PHONE_NUMBER; ?>"><?php echo PHONE_NUMBER_FORMATTED; ?></a>
                                            </h6>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="rd-navbar-collapse-items">
                            <ul class="list-inline list-inline-lg offset-top-0">
                                ...
                                <li><a href="<?php echo SOCIAL_MEDIA_FACEBOOK_URL; ?>"
                                       class="ioon icon-sm icon-silver-chalice fa-facebook"></a></li>
                                <li><a href="<?php echo SOCIAL_MEDIA_TWITTER_URL; ?>"
                                       class="ioon icon-sm icon-silver-chalice fa-twitter"></a></li>
                                <li><a href="<?php echo SOCIAL_MEDIA_INSTAGRAM_URL; ?>"
                                       class="ioon icon-sm icon-silver-chalice fa-instagram"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="rd-navbar-inner">
                    <div class="rd-navbar-nav-wrap">
                        ...
                        <ul class="rd-navbar-nav">
                            ...
                            <?php } else { ?>
                                <li class="thin" style="margin-left: auto;"><a href="/auth/login"
